...
abstract class RoomDao<I : Any, T : RoomEntity<I>>(
     ...
     */
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    abstract fun save(vararg entities: T)

    /**
     * Add or replace [entities]
     */
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    abstract fun save(entities: List<T>)

    /**
     * Add an [entity] and fail if it already exists.
     */
    @Insert(onConflict = OnConflictStrategy.ABORT)
    abstract suspend fun add(entity: T): Long

    /**
     * Add [entities] and fail if it already exists.
     */
    @Insert(onConflict = OnConflictStrategy.ABORT)
